      ...
      <form className="details" onSubmit={handleSubmit}>
        <div className="row">
          ...
          <select
            ...
            required
          >
            <option value=""> <span className="star">*</span>Discipline</option>
          ...
          <select
            ...
            required
          >
            <option value=""><span className="star">*</span>Year Of Passing</option>
        ...
        {prevList.length > 0 ? (
          ...
          <>
            <p className="centertext">No previous Educational added</p>
          </>
        )}
      </form>
    </div>
